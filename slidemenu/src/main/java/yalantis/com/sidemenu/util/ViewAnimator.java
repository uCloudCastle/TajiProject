...
public class ViewAnimator<T extends Resourceble> {
    ...
    public ViewAnimator(AppCompatActivity activity,
        ...
        this(activity, items, screenShotable, drawerLayout, animatorListener, -1);
    }

    // set menu item square len (px)
    public ViewAnimator(AppCompatActivity activity,
                        List<T> items,
                        ScreenShotable screenShotable,
                        final DrawerLayout drawerLayout,
    ...
    public void showMenuContent() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (squareLen > 0) {
                viewMenu.findViewById(R.id.menu_item_container).setLayoutParams(new RelativeLayout.LayoutParams(squareLen, squareLen));
            }
